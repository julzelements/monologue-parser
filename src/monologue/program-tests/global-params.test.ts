...
const dataPairs = [
  { testJson: TEST_0, result: RESULT_0 },
  { testJson: TEST_1, result: RESULT_1 },
  { testJson: TEST_2, result: RESULT_2 },
  { testJson: TEST_3, result: RESULT_3 },
  { testJson: TEST_4, result: RESULT_4 },
];
...
describe("DRIVE, PROGRAM_NAME and KEYBOARD_OCTAVE", () => {
  describe("PROGRAM_NAME", () => {
    ...
    test.each(cases)("Expected:%p Result:%p", (paramValue, programName) => {
      expect(paramValue).toBe(programName);
    });
  });
  describe("DRIVE", () => {
    const cases = [
...
describe("ENVELOPE_GENERATOR", () => {
  ...
  describe("EG_INT", () => {
    ...
    test.skip.each(cases)("Expected:%p Result:%p", (paramValue, programName) => {
      expect(paramValue).toBe(programName);
    });
  });
  describe("EG_TARGET", () => {
