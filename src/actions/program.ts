 ...
 * @param {number} value - The value of the parameter.
 */
export const setPanelParameter = (parameter, value) => (dispatch, getState) => {
 ...
 */
export const requestCurrentProgram = () => (dispatch, getState) => {
  const { configuration, midi } = getState();
 ...
 */
export const sendCurrentProgram = () => (dispatch, getState) => {
